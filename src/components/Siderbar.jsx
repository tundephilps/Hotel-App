...
const Siderbar = () => {
  return (
    <>
      <button
        type="button"
        class="py-3 px-4 inline-flex justify-center items-center  rounded-md border border-transparent font-semibold  text-white hover:bg-lion focus:outline-none focus:ring-2 focus:ring-lion-dark focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800"
      ...
      <div
        ...
        class="hs-overlay hs-overlay-open:translate-x-0 hidden -translate-x-full fixed top-0 left-0 transition-all duration-300 transform h-full max-w-xs w-full w-full z-[60] border-r bg-lion dark:border-gray-700 [--body-scroll:true] [--overlay-backdrop:false]"
        tabindex="-1"
      >
